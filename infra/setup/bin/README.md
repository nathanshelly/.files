...
- [`setup_bits_and_pieces`](./setup_bits_and_pieces) - set up various bits and pieces ( updating submodules and more)
...
- [`setup_zsh`](./setup_zsh) - adds `zsh` to `/etc/shells`, sets it to the default shell, and loads `zsh` to install plugins & finish installation
