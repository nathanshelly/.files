...
#
# adapted from https://github.com/romkatv/powerlevel10k/blob/main/config/p10k-lean.zsh
...
# ref - https://github.com/Powerlevel9k/powerlevel9k/blob/main/README.md
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
() {
  ...
  #
  # Example output: feature:main#tag ⇣⇡ merge ~ ⊚⊚⊚
  #
