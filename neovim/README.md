...
- [`skim.vim`](#skim.vim) - configure [`skim.vim`](https://github.com/lotabout/skim.vim), a plugin for fuzzy searching files, buffers, lines, etc.
...
- utilities
  ...
  - [`skim.vim`](https://github.com/lotabout/skim.vim) - fuzzy search files, buffers, lines, etc. Configuration is complex enough to be broken out into its own file - [`skim.vim`](#skim.vim)
...
Configure [`skim.vim`](https://github.com/lotabout/skim.vim).

`skim.vim` is a plugin for fuzzy searching files, buffers, lines, etc. It is based off [`fzf.vim`](https://github.com/junegunn/fzf.vim) using [`skim`](https://github.com/lotabout/skim) as the backend.

Notable keymappings:

- `<c-p>` - fuzzy open files below current shell directory (same as `sk`)
